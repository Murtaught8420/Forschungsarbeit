...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.3\textheight}
        \includegraphics[page = 1, width=\textwidth, trim = 10cm 4cm 10cm 4cm, clip]{Abbildungen/Kapitel2/Hertz-Dipol.pdf}
        \caption{}\label{subfig:2_Hertzscher_Dipol_A}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}[c]{0.3\textheight}
        \includegraphics[page = 2, width=\textwidth, trim = 4.5cm 1.5cm 8cm 1cm, clip]{Abbildungen/Kapitel2/Hertz-Dipol.pdf}
