...
\acro{A_w}[$A_w$]{\acrounit{\Dezibel}Absorbtionsverlust}
...
\acro{n_A}[$\vec n_A$]{\acrounit{1}Normalenvektor auf der Fläche A}

\acro{q}[$q$]{\acrounit{\ampere\second}Elektrische Ladung}
\acro{R_w}[$R_w$]{\acrounit{\Dezibel}Reflektionsverlust für ebene Wellen}

\acro{S_w}[$S_w$]{\acrounit{\Dezibel}Schirmdämpfung für ebene Wellen}

\acro{t}[$t$]{\acrounit{\meter}Schirmdicke}
...
\acro{Lichtgeschwindigkeit}[$c_0$]{\acrounit{299792458}{\meter\per\second}Lichtgeschwindigkeit im Vakuum}
