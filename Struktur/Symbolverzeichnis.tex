...
\acro{f}[$f_0$]{\acrounit{\hertz}Grundfrequenz}
\acro{f_k}[$f_k$]{\acrounit{\hertz}Kritische Frequenz}
\acro{f}[$f_H$]{\acrounit{\hertz}Obere Grenzfrequenz}
\acro{f}[$f_L$]{\acrounit{\hertz}Untere Grenzfrequenz}
...
\acro{vec_j_L}[$\vec j_L$]{\acrounit{\ampere\per\square\meter}Leitungsstromdichte}
